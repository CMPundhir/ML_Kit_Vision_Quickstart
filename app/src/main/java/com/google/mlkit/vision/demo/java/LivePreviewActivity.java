...
import com.google.mlkit.vision.demo.utils.OnBarcodeDetectedListener;
...
public final class LivePreviewActivity extends AppCompatActivity
        ...
        CompoundButton.OnCheckedChangeListener, ValidTextListener, OnBarcodeDetectedListener {
    ...
    private List<String> validTextList = new ArrayList<>();
    private List<String> validBarcodeList = new ArrayList<>();
    private String validText, validBarcode;
    ...
    @Override
    public void onValidTextSuccess(String text) {
        validText = text;
        validTextList.add(text);
    ...
    public void onBarcodeDetected(String barcode) {
        ...
        validBarcodeList.add(barcode);
        if(submitDialog==null || !submitDialog.isShowing()) {
            submitDialog = CommonDialog.myDialog(this, "QR-Code Scanned", "QR-Code: " + barcode, "Continue", "Submit", new DialogInterface.OnClickListener() {
                @Override
                ...
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    CommonDialog.showFormData(LivePreviewActivity.this, validTextList, validBarcodeList);
                }
            });
        }
    }
